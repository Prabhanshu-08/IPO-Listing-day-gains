...
model_xg_boost = pickle.load(open("Xgboost.pkl", "rb"))
model_cat_boost = pickle.load(open("Catboost.pkl", "rb"))
model_RF = pickle.load(open("RandomForestRegressor.pkl", "rb"))
model_Ada_boost = pickle.load(open("AdaBoost.pkl", "rb"))
model_MLP = pickle.load(open("MLP.pkl", "rb"))
